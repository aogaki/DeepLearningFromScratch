...
| 巻   | 状態      | 内容                                                                                   |
| ---- | --------- | -------------------------------------------------------------------------------------- |
| vol1 | 5章 完了 | 2章 パーセプトロン / 3章 順伝播・softmax・MNIST 推論(93.5%)/ 4章 損失関数・数値微分・ミニバッチ学習 / 5章 誤差逆伝播(レイヤ実装・勾配確認・高速学習: 損失 2.3→0.26 を約30秒/1000回)。次は 6章。 |
| vol2 | 未着手    | —                                                                                      |
| vol3 | 未着手    | —                                                                                      |
| vol4 | 未着手    | —                                                                                      |
| vol5 | 未着手    | —                                                                                      |
...
│       ├── layers.rs       # 5.4-5.6 レイヤ(Relu/Sigmoid/Affine/SoftmaxWithLoss)
│       └── two_layer_net_backprop.rs # 5.7 逆伝播対応の2層ネット・勾配確認・高速学習
